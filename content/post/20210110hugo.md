...
ブログを静的ジェネレータである[Hugo](https://gohugo.io/)を使って作成し、
[Netlify](https://www.netlify.com/)を使ってデプロイする。
...
###  hugoのthemeの追加
今回はmainroadを選択した。
git submoduleを使うのは後でNetlifyで公開するため（[git submoduleの使い方]({{<ref "/post/20210124gitSubmodule/">}})参照）。
