...
draft: false
tags: [技術,自然言語処理,fasttext,分散表現,文書分類,課題解決,機械学習,Python]
---
...
このような状況で、**[Facebook Research](https://research.facebook.com/)が公開する[Fasttext](https://fasttext.cc/)ライブラリ**が解決策として注目されています。
...
## 関連記事
- [fasttextを使って文書分類の精度や速度を比較してみた]({{<ref "/post/20200613fasttext/">}})
